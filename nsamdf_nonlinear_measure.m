function [L,s2,sd] = nsamdf_nonlinear_measure(data,winlen,shiftlen,lag,fs,degree,plotfigure)

% This function computes the nonlinearity measure L  
% through nsAMDF (nonlinear average magnitude difference function)
% that was asserted by 
%
% ?zkurt et al. (2020), "Identification of nonlinear features in cortical and 
...
%
% plotfigure = 1 to plot nsAMDF sequences, otherwise just assign 0 to it, i.e., plotfigure = 0
%
%
%   OUTPUTS:
%
